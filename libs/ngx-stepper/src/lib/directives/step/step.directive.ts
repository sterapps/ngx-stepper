...
@Directive({
  selector: 'ng-template[ngxStep]',
})
export class NgxStep implements OnDestroy {
  ...
  public constructor(protected readonly stepper: NgxStepper, public template: TemplateRef<any>) {
